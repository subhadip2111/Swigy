...
import { ITEM_IMG_CDN_URL } from '../../constants';
import { clearCart, decrementItem, incrementItem } from '../utils/cartSlice';
import EmptyCart from "../assets/img/Screenshoot.png";
const Cart = () => {
  const cartItems = useSelector((store) => store.cart.items);
  const dispatch = useDispatch();

  return (
    <section className="md:flex md:justify-center w-4/5 mx-auto md:my-5 md:flex-wrap gap-5">
      <div className="md:w-1/2 w-full">
        <div className="flex justify-between py-2 my-2 text-lg items-center">
        ...
        {cartItems.length === 0 ? (
          <div className="text-center">
            <img
              src={EmptyCart} // Replace with your empty cart image path
              alt="Empty Cart"
            ...
            <a
              href="/" // Replace with the appropriate link to the home page
